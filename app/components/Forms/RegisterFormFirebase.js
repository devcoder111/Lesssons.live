...
RegisterFormFirebase.propTypes = {
  ...
  signUpWithFacebookFn: PropTypes.func.isRequired,
  signUpWithGoogleFn: PropTypes.func.isRequired,
  signUpWithTwitterFn: PropTypes.func.isRequired
};
...
const mapDispatchToProps = {
  signUpWithFacebookFn: signUpWithFacebook,
  signUpWithGoogleFn: signUpWithGoogle,
  signUpWithTwitterFn: signUpWithTwitter,
