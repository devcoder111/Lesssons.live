...
class Contact extends React.Component {
  ...
  render() {
    ...
    return (
      <div className={classNames(classes.contact, classes.withBg)}>
        <div className={classes.container}>
          <div className={classes.contactBubble}>
            <Title title={intl.formatMessage(messages.titleContact)} desc="Send us a note with any questions you may have." align="left" nomargin />
