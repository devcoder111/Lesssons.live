...
export const socialSignUp = authProvider => ({
...
export const registerSuccess = credential => ({
...
export const signUpWithFacebook = () => socialSignUp(
  new firebase.auth.FacebookAuthProvider()
);

export const signUpWithGoogle = () => socialSignUp(
  new firebase.auth.GoogleAuthProvider()
);

export const signUpWithTwitter = () => socialSignUp(
...
export const signInWithFacebook = () => login(
  new firebase.auth.FacebookAuthProvider()
);
