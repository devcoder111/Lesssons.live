        ...
        <div className={classes.container}>
          <section className={classes.userFormWrap}>
            <div className={Type.textCenter}>
              <NavLink
                to="/"
                className={classNames(classes.brand, classes.centerFlex)}
              >
            ...
            >
              <Typography
                variant="h4"
                className={classNames(classes.title, Type.textCenter)}
                gutterBottom
              >
              ...
              >
                ...
                (&quot;you&quot;) and Lessons.Live (&quot;Company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;),
                concerning your access to and use of the https://lessons.live
              ...
              >
                ...
                <br />
                1. Trick, defraud, or mislead us and other users, especially in
                any attempt to learn sensitive account information such as user
                passwords. 2. Disparage, tarnish, or otherwise harm, in our
                opinion, us and/or the Site. 3. Use any information obtained
                from the Site in order to harass, abuse, or harm another person.
                4. Use the Site in a manner inconsistent with any applicable
                laws or regulations. 5. Use the Site to advertise or offer to
                sell goods and services. 6. Attempt to impersonate another user
                or person or use the username of another user. 7. Copy or adapt
                the Site’s software, including but not limited to Flash, PHP,
                HTML, JavaScript, or other code. 8. Decipher, decompile,
                disassemble, or reverse engineer any of the software comprising
                or in any way making up a part of the Site. 9. Make any
              ...
              >
                ...
                or abuse anyone. 8. Your Contributions do not advocate the
                violent overthrow of any government or incite, encourage, or
                threaten physical harm against another. 9. Your Contributions do
                ...
                material that solicits personal information from anyone under
                the age of 18 or exploits people under the age of 18 in a sexual
                or violent manner. 12. Your Contributions do not violate any
                applicable law concerning child pornography, or otherwise
                intended to protect the health or well-being of minors; 13. Your
                Contributions do not include any offensive comments that are
                connected to race, national origin, gender, sexual preference,
                or physical handicap. 14. Your Contributions do not otherwise
              ...
              >
                ...
                within the State of Arizona, without regard to its conflict of
                law principles.
                <br />
                <br />
                {' '}
              ...
              >
                ...
                Arizona. Except as otherwise provided herein, the Parties may
              ...
              >
                ...
                PAID, IF ANY, BY YOU TO US OR __________. CERTAIN US STATE LAWS
              ...
              <article>
                ...
                <Typography
                  ...
                  align="left"
                >
                  When creating a new account, both during registration via
                  email and social media, your data in the database is not
                  permanent. We can remove it anytime without giving prior
                  notice. If it has been deleted and then you want to log in
                  again, then please create a new account.
                </Typography>
                <Typography
                  variant="caption"
                  className={classes.subtitle}
