...
// Lessons Live Pages
export const LessonsLiveDashboard = Loadable({
  loader: () => import('./LessonsLive/Dashboard'),
  loading: Loading,
});
export const LessonsLiveMusicians = Loadable({
  loader: () => import('./LessonsLive/Musicians'),
  loading: Loading,
});
export const LessonsLiveMusicianProfile = Loadable({
  loader: () => import('./LessonsLive/MusicianProfile'),
  loading: Loading,
});
export const LessonsLiveRegularProfile = Loadable({
  loader: () => import('./LessonsLive/RegularProfile'),
  loading: Loading,
});
...
export const LessonsLiveCheckout = Loadable({
  loader: () => import('./LessonsLive/Checkout'),
  loading: Loading,
});

export const LessonsLessonRoom = Loadable({
  loader: () => import('./LessonsLive/LessonRoom'),
  loading: Loading,
});

export const LessonsLiveSchedule = Loadable({
  loader: () => import('./LessonsLive/Schedule'),
  loading: Loading,
});
...
export const Lesson = Loadable({
  loader: () => import('./LessonsLive/Lesson'),
  loading: Loading,
});
